...
const NewPasswordForm = () => {
    ...
    const NewPasswordSchema=Yup.object().shape({
        newPassword:Yup.string().required("Password is required").min(10,"Password must be min of 10 characters"),
        confirmPassword:Yup.string().required("Password is required").oneOf([Yup.ref('newPassword'),null],
        "Paswords must match"),
    })
    const defaultValues={
        newPassword:"",
  ...
  return (
    ...
    <RHFTextField name="confirmPassword"
